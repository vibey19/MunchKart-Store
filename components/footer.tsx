    ...
    <footer className="bg-hero">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex justify-center text-white capitalize text-3xl font-bold sm:justify-start">
              MUNCHKART
            </div>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="flex-1 text-black">0123456789</span>
                  </a>
                </li>
                ...
                <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                  ...
                  <address className="-mt-0.5 flex-1 not-italic text-black">
                    Kansara Bazar, Manek Chowk Rd, Old City, Danapidth, Khadia,
                    Ahmedabad
                  </address>
                </li>
              </ul>
